...
class forward_warp_function(Function):
    ...
    @staticmethod
    def forward(ctx, im0, flow, flowback, interpolation_mode,inpaint_search_radius, inpaint_motion_threshold):
        '''
        ...
        im1 = forward_warp_cuda.forward(im0, flow, flowback, interpolation_mode,inpaint_search_radius, inpaint_motion_threshold)
        return im1
...
class forward_warp(Module):
    ...
    def forward(self, im0, flow, flowback, inpaint_search_radius, inpaint_motion_threshold):
        return forward_warp_function.apply(im0, flow, flowback, self.interpolation_mode,inpaint_search_radius, inpaint_motion_threshold)
